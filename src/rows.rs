...
pub struct Rows<I: Iterator> {
    inner: Option<Inner<I>>,
}

impl<I: Iterator> Rows<I> {
...
pub struct Head<I: Iterator> {
    rows: Rc<RefCell<Rows<I>>>,
    inner: Option<Inner<I>>,
}

impl<'a, I: Iterator<Item = Lexeme<'a>>> Iterator for Head<I> {
    type Item = &'a str;
...
impl<I: Iterator> Drop for Head<I> {
    fn drop(&mut self) {
...
pub struct Tail<I: Iterator> {
    rows: Rc<RefCell<Rows<I>>>,
    inner: Option<Inner<I>>,
}

impl<I: Iterator> Tail<I> {
...
pub struct TailRow<'t, I: Iterator> {
    tail: &'t mut Tail<I>,
    cols_left: usize,
    state: TailRowState,
}

impl<'a, 't, I: Iterator> TailRow<'t, I> {
...
impl<'a, I: Iterator<Item = Lexeme<'a>>> Iterator for TailRow<'_, I> {
    type Item = &'a str;
